...
import { createAccount, createUserProfile, signInWithGoogle } from "@/lib/firebase";
...
const Signup = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      // Google sign-in will also handle creating the user profile
  ...
  return (    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Join SPARK to start your wellness journey
          </CardDescription>
        </CardHeader>
        <CardContent>
