...
const Dashboard = () => {
  ...
  // Simulate data loading with faster display
  useEffect(() => {
    ...
    }, 500); // Short timeout to prevent UI blocking
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Use placeholder skeleton if loading */}
          {isLoading ? (
            Array(4).fill(0).map((_, index) => (
              <Card key={index}>
                ...
                <CardContent>
                  <div className="h-7 w-16 bg-gray-200 animate-pulse rounded mb-2"></div>
        ...
        {/* Quick Actions - Always show this first for better perceived performance */}
        <Card>
          <CardHeader>
        ...
        {/* Remaining sections (loaded progressively) */}
        {!isLoading && (
